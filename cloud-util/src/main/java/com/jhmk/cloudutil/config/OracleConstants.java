...
public class OracleConstants {
    ...
    //广安门入院记录视图
    public final static String GAM_RYJLURL = "jdbc:oracle:thin:@172.16.254.13:1521/orcl";
    public final static String GAM_RYJLUSERNAME = "emr_analysis";
    public final static String GAM_RYJLPASSWORD = "gam_jiahe";
