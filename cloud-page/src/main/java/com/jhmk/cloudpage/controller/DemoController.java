...
//2、获取输出流，向服务器端发送信息
        ...
        pw.write("0000969000#1###ruyuanjilu");
...
//4、关闭资源
    ...
    public void getRule(HttpServletResponse response) {
        ...
        Binganshouye binganshouyeFromETL = binganshouyeService.getBinganshouyeFromETL("0000969000", "1",socketPropConf.getIp(),socketPropConf.getPort2());
        jiaheRuleBean.setBinganshouye(binganshouyeFromETL);
        List<Jianyanbaogao> jianyanbaogao = jianyanbaogaoService.getJianyanbaogao(jiaheRuleBean,socketPropConf.getIp(),socketPropConf.getPort());
        List<Jianyanbaogao> distinctJianyanbaogao = jianyanbaogaoService.getDistinctJianyanbaogao(jianyanbaogao);
        List<Jianchabaogao> jianchabaogao = jianchabaogaoService.getJianchabaogao(jiaheRuleBean,socketPropConf.getIp(),socketPropConf.getPort());
        wirte(response, "123");
    }
}
